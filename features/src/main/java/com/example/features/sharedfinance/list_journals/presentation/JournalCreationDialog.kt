    ...
    Dialog(
        ...
        Card(
            ...
            Column(
                ...
                SFTextField(
                    text = viewModel.journalTextState.value.text,
                    modifier = Modifier.wrapContentWidth(),
                    onValueChange = {
                        viewModel.onEvent(ListJournalsEvent.EnteredJournalName(it))
                    },
                    singleLine = true,
                ...
                Row(
                    ...
                    Text(
                        text = "${viewModel.journalTextState.value.text.length}/${ListJournalsViewModel.MAX_LETTER_COUNT}",
                ...
                Button(
                    modifier = Modifier
                        ...
                        .animateContentSize(),
                    onClick = {
                        onSubmit(viewModel.journalTextState.value.text)
                    }
                ) {
