package com.example.features.sharedfinance.home.journal.presentation.edit_dialog
...
fun EditNoteDialog(
    ...
    val state = viewModel.dialogEditionState.value
    ...
    Dialog(
        ...
        Card(
            ...
            Column(
                ...
                SFTextField(
                    text = viewModel.sumEditionTextState.value.text,
                    modifier = Modifier
                        .wrapContentWidth()
                        .padding(8.dp),
                    onValueChange = {
                        viewModel.onEvent(JournalEvent.EditedSum(it))
                    },
                    singleLine = true,
                ...
                ExposedDropdownMenuBox(
                    ...
                    SFTextField(
                        text = viewModel.categoryEditionTextState.value.text,
                        onValueChange = {},
                        readOnly = true,
                    ...
                    ExposedDropdownMenu(
                        ...
                        categoriesState.categories.forEach { selectedOption ->
                            DropdownMenuItem(onClick = {
                                viewModel.onEvent(JournalEvent.EditedCategory(selectedOption.name))
                                expanded = false
                            }) {
                ...
                SFTextField(
                    text = viewModel.commentEditionTextState.value.text,
                    modifier = Modifier
                        .wrapContentWidth()
                        .padding(8.dp),
                    onValueChange = {
                        viewModel.onEvent(JournalEvent.EditedComment(it))
                    },
                    singleLine = true,
                ...
                Button(
                    ...
                    onClick = {
                        onSubmit(
                            viewModel.idNoteState.value.text.toLong(),
                            viewModel.dateNoteState.value.text,
                            viewModel.sumEditionTextState.value.text,
                            viewModel.categoryEditionTextState.value.text,
                            viewModel.commentEditionTextState.value.text,
                        )
                    }
                ) {
